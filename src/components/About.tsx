      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="prose prose-lg prose-invert max-w-none mb-12">
          <p className="text-xl text-foreground/90 leading-relaxed mb-6">
            Waypoint Labs LLC is on a mission to build technology that empowers people to explore the world. Our goal is
            to create innovative solutions that support meaningful journeys—whether on the road, in the field, or
