...
const statusColors = {
  ...
  Concept: "bg-orange-500/20 text-orange-400 border-orange-500/50",
  Internal: "bg-green-500/20 text-green-400 border-green-500/50",
};
export const ProjectCard = ({ project }: ProjectCardProps) => {
  return (
    <Card className="group h-full flex flex-col bg-card/80 backdrop-blur border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10">
      <CardHeader>
